...
class Widget extends DmYY {
  constructor(arg) {
    ...
    this.logo =
      "https://vkceyugu.cdn.bspapp.com/VKCEYUGU-b1ebbd3c-ca49-405b-957b-effe60782276/855b2333-0c1b-4bc1-9178-aac0c24119a0.png";
    this.smallLogo =
      "https://vkceyugu.cdn.bspapp.com/VKCEYUGU-b1ebbd3c-ca49-405b-957b-effe60782276/b219c861-0b33-4fee-8245-e304275fc2ef.png";
    this.Run();
  }
  ...
  async queryFlow() {
    try {
      ...
      if (data.retCode === "000000") {
        ...
        if (voiceRes) {
          this.voice.percent = (
            (voiceRes.allRemainRes / (voiceRes.allTotalRes || 1)) *
            100
          ).toFixed(2);
